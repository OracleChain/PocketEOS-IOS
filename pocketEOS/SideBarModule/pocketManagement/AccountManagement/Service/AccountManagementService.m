...
- (void)buildDataSource:(CompleteBlock)complete{
    if (LEETHEME_CURRENTTHEME_IS_SOCAIL_MODE) {
        self.dataSourceArray = [NSMutableArray arrayWithObjects:NSLocalizedString(@"设为主账号", nil), NSLocalizedString(@"EOS资源管理", nil), NSLocalizedString(@"导出私钥", nil),  nil];//,NSLocalizedString(@"保护隐私", nil) , NSLocalizedString(@"EOS一键赎回", nil)
