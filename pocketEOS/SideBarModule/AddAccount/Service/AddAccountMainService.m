...
-(void)buildDataSource:(CompleteBlock)complete{
    NSMutableArray *itemArr = [NSMutableArray arrayWithObjects:NSLocalizedString(@"导入EOS账号", nil), NSLocalizedString(@"付费创建", nil), NSLocalizedString(@"我是VIP", nil), NSLocalizedString(@"限时免费", nil), nil];
